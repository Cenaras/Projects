...
public class  Parser implements ParserConstants {
    public static void main(String[] args) {
                     try {
                         ...
                         Program result = new Parser(new java.io.StringReader(program)).S(); //Read the program from cmd line and parse with S() as start
...
//< LET > <ID > < ASSIGNEQ > <INT>
  static final public Program S() throws ParseException {
              StatementList s;
    s = StmList();
    jj_consume_token(0);
                          {if (true) return new Program(s);}
    throw new Error("Missing return statement in function");
  }

  static final public StatementList StmList() throws ParseException {
                          Statement s1;
    s1 = Stm();
    label_1:
    while (true) {
      ...
      Stm();
                                       ...
                                       StatementList statements = new StatementList(); statements.addStatement(s1); {if (true) return statements;}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Statement Stm() throws ParseException {
    ...
    exp = Exp();
    jj_consume_token(SEMICOLON);
                                                                  {if (true) return new LetStm(id.image, exp);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x100,0x30,0xc0,0xc0,0x30,};
   }
